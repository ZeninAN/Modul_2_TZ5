...
var owner = new OwnerClass("Зенин", "Андрей", "Сергеевич", new Date(2005, 1, 3), TypeDocument.Passport, "1234", "567890");
var vehicle = new VehicleClass("Chevrole", "Corvette", 2016, "JTDBE32K620055880", "228IVT", owner);
...
var car = new CarClass("BMW", "X5", 2021, "WBAFY42040L456789", "B456XY77", owner, BodyType.SUV, CarType.Premium);
var motorbike = new MotorbikeClass("Yamaha", "YZF-R1", 2019, "JYARN23E0KA003456", "M123YY77", owner, "Спортивная", true);
var storage = new VehicleStorageClass();
