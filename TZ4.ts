namespace Transport {
    ...
    export interface Car extends Transport.Vehicle {
        bodyType: BodyType;
        carClass: CarClass;
        printVehicleInfo(): void;
    }

    export interface Motorbike extends Transport.Vehicle {
        frameType: string;
        isForSport: boolean;
        printVehicleInfo(): void;
    }
    ...
    export class MotorbikeClass implements Motorbike {
        private _brand: string;
        private _model: string;
        private _year: number;
        private _vin: string;
    ...
    export interface VehicleStorage<T extends Transport.Vehicle> {
        creationDate: Date;
        vehicles: T[];
        getAllVehicles(): T[];
    }

    export class VehicleStorageClass<T extends Transport.Vehicle> implements VehicleStorage<T> {
        creationDate: Date;
        vehicles: T[];
